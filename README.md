...
:warning: **This Composable Commerce PHP SDK is deprecated effective `1st September 2022.`, We recommend to use our [PHP SDK V2](https://docs.commercetools.com/sdk/php-sdk#php-sdk-v2).
