...
class FacetTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testFacetCountingProducts()
    {
        $facet = Facet::ofName('test')->countingProducts(true);
        $this->assertSame('test counting products', (string)$facet);
    }

    public function testFacetCountingProductsWithValue()
    {
        $facet = Facet::ofName('test')->setValue('red')->countingProducts(true);
        $this->assertSame('test:"red" counting products', (string)$facet);
    }

    public function testFacetNotCountingProducts()
    {
        $facet = Facet::ofName('test')->countingProducts(false);
        $this->assertSame('test', (string)$facet);
    }
}
